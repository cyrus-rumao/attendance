  ...
  const handleLogout = async (): Promise<void> => {
	...
	return (
		<nav className="fixed top-0 left-0 w-full h-16 px-8 flex items-center justify-between bg-black/40 backdrop-blur-md border-b border-amber-900/30 z-50">
			...
			<Link
				to="/"
				className="text-xl font-bold tracking-tighter bg-gradient-to-r from-amber-200 via-amber-500 to-amber-200 bg-clip-text text-transparent hover:opacity-80 transition">
